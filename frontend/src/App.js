...
import { createAccount, deleteAccount, getAccounts, getAutoSyncStatus, getDailyEstimateSummary, getTaskPlayGrowth, getTaskVideos, launchLogin, runAllSync, syncAccount } from "./api";
    ...
    for (const row of rows) {
        ...
        if (!taskGroup) {
            taskGroup = {
                ...
                todayEstimatedDelta: getTaskEstimatedDelta(row.missionEstimatedAmount, row.yesterdayTaskPredictedAmount, row.hasYesterdayTaskBaseline === 1),
...
function buildRankingStats(tasks, dailyEstimateSummary) {
    ...
    return {
        ...
        dailyDelta: dailyEstimateSummary?.yesterdayEstimatedTotal === null ||
...
export default function App() {
    ...
    const [playGrowthPage, setPlayGrowthPage] = useState(null);
    ...
    return (_jsxs("main", { className: "page", children: [_jsxs("section", { className: "hero", children: [_jsxs("div", { children: [_jsx("p", { className: "eyebrow", children: "\u672C\u5730\u7F51\u9875 + \u672C\u5730\u91C7\u96C6\u670D\u52A1" }), _jsx("h1", { children: "\u6296\u97F3\u4EFB\u52A1\u6570\u636E\u7EDF\u8BA1" }), _jsx("p", { className: "subtle", children: "\u73B0\u5728\u6309\u201C\u8D26\u53F7 \u2192 \u4EFB\u52A1 \u2192 \u89C6\u9891\u201D\u5C42\u7EA7\u5C55\u793A\u4EFB\u52A1\u8BE6\u60C5\u3002\u4EFB\u52A1\u5934\u90E8\u663E\u793A\u603B\u9884\u4F30\u6536\u76CA\uFF0C\u89C6\u9891\u884C\u663E\u793A\u5355\u6761\u9884\u4F30\u5206\u4F63\u91D1\u989D\u548C\u64AD\u653E\u6570\u636E\u3002" }), autoSyncStatus ? (_jsxs("div", { className: "sync-summary", children: [_jsxs("p", { children: ["\u81EA\u52A8\u540C\u6B65\uFF1A", autoSyncStatus.isRunning
                                        ...
                                        return (_jsxs("section", { className: "account-section", children: [_jsxs("div", { className: "account-section-header", children: [_jsxs("div", { className: "account-section-summary", children: [_jsx("h3", { children: accountGroup.accountName }), _jsxs("span", { children: ["\u603B\u9884\u4F30\uFF1A", formatMoney(accountGroup.totalEstimatedIncome)] })] }), _jsxs("div", { className: "account-section-actions", children: [_jsxs("span", { children: [accountGroup.tasks.length, " \u4E2A\u4EFB\u52A1"] }), _jsx("button", { type: "button", className: "secondary", onClick: () => toggleTaskAccountCollapse(accountGroup.accountId), children: collapsed ? "展开" : "收起" })] })] }), !collapsed
                                    ...
                                    }), groupedRows.length === 0 ? _jsx("p", { className: "empty", children: "\u5F53\u524D\u6CA1\u6709\u4EFB\u52A1\u89C6\u9891\u6570\u636E\uFF0C\u8BF7\u5148\u540C\u6B65\u8D26\u53F7\u3002" }) : null] }), groupedRows.length > 0 ? (_jsxs("div", { className: "pagination", children: [_jsx("button", { type: "button", className: "secondary", onClick: () => setCurrentPage((page) => Math.max(1, page - 1)), disabled: currentPage === 1, children: "\u4E0A\u4E00\u9875" }), _jsxs("span", { children: ["\u7B2C ", currentPage, " / ", totalPages, " \u9875"] }), _jsx("button", { type: "button", className: "secondary", onClick: () => setCurrentPage((page) => Math.min(totalPages, page + 1)), disabled: currentPage === totalPages, children: "\u4E0B\u4E00\u9875" })] })) : null] })) : taskView === "ranking" ? (_jsxs(_Fragment, { children: [_jsxs("div", { className: "ranking-summary", children: [_jsxs("div", { children: [_jsx("span", { children: "\u4ECA\u65E5\u6709\u66F4\u65B0\u4EFB\u52A1\u6570" }), _jsx("strong", { children: rankingStats.updatedTaskCount })] }), _jsxs("div", { children: [_jsx("span", { children: "\u4ECA\u65E5\u9884\u4F30\u589E\u91CF" }), _jsx("strong", { className: isNegativeMoney(rankingStats.dailyDelta) ? "amount-negative" : "amount-positive", children: formatMoney(rankingStats.dailyDelta) })] }), _jsxs("div", { children: [_jsx("span", { children: "\u6709\u589E\u91CF\u8D26\u53F7\u6570" }), _jsx("strong", { children: rankingStats.updatedAccountCount })] }), _jsxs("div", { children: [_jsx("span", { children: "\u589E\u91CF\u6700\u9AD8\u4EFB\u52A1" }), _jsx("strong", { className: "top-task-name", children: rankingStats.topTask
                                                ...
                                                return (_jsxs(Fragment, { children: [_jsxs("tr", { children: [_jsx("td", { className: index + (rankingPage - 1) * RANKING_TASKS_PER_PAGE < 3 ? "rank-top" : "", children: index + 1 + (rankingPage - 1) * RANKING_TASKS_PER_PAGE }), _jsx("td", { children: task.accountName }), _jsx("td", { children: task.taskName }), _jsx("td", { children: formatMoney(task.yesterdayEstimatedIncome) }), _jsx("td", { children: formatMoney(task.estimatedIncome) }), _jsx("td", { className: isNegativeMoney(task.todayEstimatedDelta) ? "amount-negative" : "amount-positive", children: formatMoney(task.todayEstimatedDelta) }), _jsx("td", { children: task.todayPublishedCount }), _jsx("td", { children: formatTime(task.lastSyncedAt) }), _jsx("td", { children: "\u89C6\u9891\u660E\u7EC6\u89C1\u4E0B\u65B9" })] }), _jsx("tr", { className: "ranking-detail-row", children: _jsx("td", { colSpan: 9, children: _jsx("div", { className: "table-wrap", children: _jsxs("table", { className: "ranking-video-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "\u89C6\u9891\u6807\u9898" }), _jsx("th", { children: "\u53D1\u5E03\u65F6\u95F4" }), _jsx("th", { children: "\u6628\u65E5\u9884\u4F30" }), _jsx("th", { children: "\u5F53\u524D\u9884\u4F30" }), _jsx("th", { children: "\u4ECA\u65E5\u589E\u91CF" }), _jsx("th", { children: "\u4EFB\u52A1\u53E3\u5F84\u64AD\u653E\u91CF" }), _jsx("th", { children: "\u5F53\u524D\u64AD\u653E\u91CF" }), _jsx("th", { children: "\u64AD\u653E\u91CF\u5DEE\u503C" }), _jsx("th", { children: "\u5DF2\u53D1\u653E\u6536\u76CA" }), _jsx("th", { children: "\u89C6\u9891\u72B6\u6001" })] }) }), _jsx("tbody", { children: task.videos.map((row) => (_jsxs("tr", { children: [_jsx("td", { children: row.videoTitle ?? "--" }), _jsx("td", { children: formatTime(row.publishedAt) }), _jsx("td", { children: formatMoney(row.yesterdayPredictedAmount) }), _jsx("td", { children: formatMoney(row.predictedAmount) }), _jsx("td", { className: isNegativeMoney(row.todayPredictedDelta) ? "amount-negative" : "amount-positive", children: formatMoney(row.todayPredictedDelta) }), _jsx("td", { children: formatNumber(row.xingtuPlayCount) }), _jsx("td", { children: formatNumber(row.actualPlayCount) }), _jsx("td", { children: formatNumber(row.playDelta) }), _jsx("td", { children: formatMoney(row.settledAmount) }), _jsx("td", { children: row.videoStatus ? (videoStatusLabels[row.videoStatus] ?? row.videoStatus) : "--" })] }, row.taskId))) })] }) }) }) })] }, taskKey));
                                            }) })] }) })), rankingTasks.length > RANKING_TASKS_PER_PAGE ? (_jsxs("div", { className: "pagination", children: [_jsx("button", { type: "button", className: "secondary", onClick: () => setRankingPage((page) => Math.max(1, page - 1)), disabled: rankingPage === 1, children: "\u4E0A\u4E00\u9875" }), _jsxs("span", { children: ["\u7B2C ", rankingPage, " / ", rankingTotalPages, " \u9875"] }), _jsx("button", { type: "button", className: "secondary", onClick: () => setRankingPage((page) => Math.min(rankingTotalPages, page + 1)), disabled: rankingPage === rankingTotalPages, children: "\u4E0B\u4E00\u9875" })] })) : null] })) : (_jsxs(_Fragment, { children: [playGrowthPage === null ? (_jsx("p", { className: "empty", children: "\u6B63\u5728\u52A0\u8F7D\u64AD\u653E\u91CF\u589E\u957F\u6570\u636E..." })) : playGrowthPage.items.length === 0 ? (_jsx("p", { className: "empty", children: "\u5F53\u524D\u6CA1\u6709\u4EFB\u52A1\u64AD\u653E\u91CF\u6570\u636E\u3002" })) : (_jsx("div", { className: "table-wrap ranking-table-wrap", children: _jsxs("table", { className: "play-growth-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "\u8D26\u53F7\u540D\u79F0" }), _jsx("th", { children: "\u5F53\u524D\u64AD\u653E\u91CF" }), _jsx("th", { children: "\u589E\u957F\u64AD\u653E\u91CF" }), _jsx("th", { children: "\u65E5\u589E\u957F\u64AD\u653E\u91CF" }), _jsx("th", { children: "\u89C6\u9891\u53D1\u5E03\u65F6\u95F4" }), _jsx("th", { children: "\u4EFB\u52A1\u540D\u79F0" })] }) }), _jsx("tbody", { children: playGrowthPage.items.map((row, index) => (_jsxs("tr", { children: [_jsx("td", { children: row.accountName }), _jsx("td", { children: formatNumber(row.actualPlayCount) }), _jsx("td", { children: formatNumber(row.playGrowth) }), _jsx("td", { children: formatNumber(row.dailyPlayGrowth) }), _jsx("td", { children: formatTime(row.publishedAt) }), _jsx("td", { children: row.taskName })] }, `${row.accountName}:${row.taskName}:${row.publishedAt ?? ""}:${index}`))) })] }) })), playGrowthPage !== null && playGrowthPage.total > playGrowthPage.pageSize ? (_jsxs("div", { className: "pagination", children: [_jsx("button", { type: "button", className: "secondary", onClick: () => setPlayGrowthCurrentPage((page) => Math.max(1, page - 1)), disabled: playGrowthPage.page === 1, children: "\u4E0A\u4E00\u9875" }), _jsxs("span", { children: ["\u7B2C ", playGrowthPage.page, " / ", Math.max(1, Math.ceil(playGrowthPage.total / playGrowthPage.pageSize)), " \u9875"] }), _jsx("button", { type: "button", className: "secondary", onClick: () => setPlayGrowthCurrentPage((page) => Math.min(Math.max(1, Math.ceil(playGrowthPage.total / playGrowthPage.pageSize)), page + 1)), disabled: playGrowthPage.page >= Math.ceil(playGrowthPage.total / playGrowthPage.pageSize), children: "\u4E0B\u4E00\u9875" })] })) : null] }))] })] }));
}
