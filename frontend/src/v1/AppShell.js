...
function Metric({ label, value, caption, tone = "default", prominent = false }) {
    return (_jsxs("article", { className: `v1-metric v1-metric-${tone}${prominent ? " v1-metric-prominent" : ""}`, children: [_jsx("span", { children: label }), _jsx("strong", { children: value }), _jsx("small", { children: caption })] }));
}
function AccountStatusMetric({ activeValue, activeCaption, pendingValue, pendingCaption, pendingTone }) {
    return (_jsxs("article", { className: "v1-metric v1-account-metric", "aria-label": "\u8D26\u53F7\u72B6\u6001", children: [_jsxs("div", { className: "v1-account-metric-row", children: [_jsxs("div", { children: [_jsx("span", { children: "\u6D3B\u8DC3\u8D26\u53F7" }), _jsx("strong", { children: activeValue })] }), _jsx("small", { children: activeCaption })] }), _jsxs("div", { className: `v1-account-metric-row v1-account-metric-row-${pendingTone}`, children: [_jsxs("div", { children: [_jsx("span", { children: "\u5F85\u5904\u7406\u8D26\u53F7" }), _jsx("strong", { children: pendingValue })] }), _jsx("small", { children: pendingCaption })] })] }));
}
function EmptyState({ title }) {
    return _jsx("div", { className: "v1-empty", children: title });
}
function LoadingState() {
    return (_jsxs("div", { className: "v1-loading-state", "aria-label": "\u6B63\u5728\u52A0\u8F7D\u6570\u636E", children: [_jsx("div", { className: "v1-skeleton-grid", children: Array.from({ length: 6 }, (_, index) => _jsx("div", { className: "v1-skeleton-metric" }, index)) }), _jsxs("div", { className: "v1-skeleton-panel", children: [_jsx("span", {}), _jsx("span", {}), _jsx("span", {}), _jsx("span", {})] })] }));
}
export default function AppShell() {
    const [page, setPage] = useState("dashboard");
    const [data, setData] = useState({ accounts: [], rows: [], videos: [], summary: null, dashboard: null, sync: null });
    ...
    return (_jsxs("div", { className: "v1-app", children: [_jsxs("aside", { className: "v1-sidebar", "aria-label": "\u4E3B\u5BFC\u822A", children: [_jsxs("div", { className: "v1-brand", children: [_jsx("span", { children: "DY" }), _jsxs("div", { children: [_jsx("strong", { children: "\u661F\u56FE\u9A7E\u9A76\u8231" }), _jsx("small", { children: "v1 \u5F00\u53D1\u7248" })] })] }), _jsx("nav", { children: navigation.map((item) => (_jsx("button", { type: "button", className: page === item.id ? "v1-nav-item active" : "v1-nav-item", onClick: () => setPage(item.id), children: item.label }, item.id))) }), _jsxs("div", { className: "v1-sidebar-footer", children: [_jsx("span", { children: "\u6570\u636E\u65E5\u671F" }), _jsx("strong", { children: getShanghaiDate(new Date()) })] })] }), _jsxs("main", { className: "v1-main", children: [_jsxs("header", { className: "v1-topbar", children: [_jsxs("div", { children: [_jsx("p", { children: "\u6296\u97F3\u661F\u56FE\u7ECF\u8425\u9A7E\u9A76\u8231" }), _jsx("h1", { children: pageTitles[page] })] }), _jsxs("div", { className: "v1-topbar-actions", children: [_jsxs("span", { className: "v1-last-updated", children: ["\u66F4\u65B0\u4E8E ", formatDateTime(insights.lastSyncAt)] }), _jsx("button", { type: "button", className: "v1-refresh", onClick: () => void refresh(), disabled: loading, children: loading ? "更新中" : "刷新" })] })] }), error ? _jsx("div", { className: "v1-alert", role: "alert", children: error }) : null, _jsxs("div", { className: "v1-workspace", children: [_jsx("section", { className: "v1-content", "aria-busy": loading, children: loading && data.accounts.length === 0 ? _jsx(LoadingState, {}) : _jsxs(_Fragment, { children: [page === "dashboard" ? (_jsxs(_Fragment, { children: [_jsxs("div", { className: "v1-metric-grid", children: [_jsx(Metric, { label: "\u4ECA\u65E5\u5B9E\u65F6\u9884\u4F30", value: formatMoney(summary?.todayEstimatedTotal), caption: "\u5B9E\u65F6", prominent: true }), _jsx(Metric, { label: "\u6628\u65E5\u6700\u7EC8\u9884\u4F30", value: formatMoney(summary?.yesterdayEstimatedTotal), caption: "\u6628\u65E5\u5DF2\u7ED3\u7B97" }), _jsx(Metric, { label: "\u4ECA\u65E5\u589E\u91CF", value: formatSignedMoney(summary?.dailyIncrease), caption: summary?.isComplete ? "实时对昨日已结算" : "待补全", tone: deltaTone }), _jsx(Metric, { label: "\u4ECA\u65E5\u65B0\u589E\u64AD\u653E\u91CF", value: formatSignedNumber(data.dashboard?.dailyPlayGrowth), caption: `${data.dashboard?.dailyPlayGrowthCoverage.eligibleVideos ?? 0} / ${data.dashboard?.dailyPlayGrowthCoverage.totalVideos ?? 0} 个视频有昨日基线`, tone: (data.dashboard?.dailyPlayGrowth ?? 0) < 0 ? "negative" : "positive" }), _jsx(Metric, { label: "\u4ECA\u65E5\u5DF2\u53D1\u5E03\u89C6\u9891", value: formatNumber(insights.publishedToday), caption: "\u6309\u4E0A\u6D77\u65E5\u671F" }), _jsx(AccountStatusMetric, { activeValue: formatNumber(data.dashboard?.accounts.activeCount ?? insights.activeAccounts), activeCaption: `${formatNumber(data.accounts.length)} 个账号`, pendingValue: formatNumber(data.dashboard?.accounts.pendingSyncCount ?? insights.exceptions.length), pendingCaption: summary?.isComplete ? "数据完整" : "快照待补全", pendingTone: insights.exceptions.length ? "negative" : "positive" })] }), _jsxs("div", { className: "v1-section-header", children: [_jsxs("div", { children: [_jsx("h2", { children: "\u9700\u8981\u5904\u7406" }), _jsx("span", { children: "\u767B\u5F55\u3001\u540C\u6B65\u548C\u6570\u636E\u5B8C\u6574\u5EA6" })] }), _jsx(StatusBadge, { label: summary?.isComplete ? "快照完整" : "待补全", tone: summary?.isComplete ? "good" : "warn" })] }), insights.exceptions.length === 0 && insights.staleAccounts.length === 0 ? (_jsx(EmptyState, { title: "\u5F53\u524D\u6CA1\u6709\u5F85\u5904\u7406\u8D26\u53F7" })) : (_jsx("div", { className: "v1-queue", children: [...insights.exceptions.map((account) => ({ id: account.accountId, displayName: account.displayName, lastError: account.message, lastSyncAt: account.lastSyncAt })), ...insights.staleAccounts.filter((account) => !insights.exceptions.some((item) => item.accountId === account.id))]
                                                        .slice(0, 6)
                                                        .map((account) => {
...
function VideoGrowthTable({ rows }) {
    const [sort, setSort] = useState(null);
    ...
    if (sortedRows.length === 0)
        return _jsx(EmptyState, { title: "\u6682\u65E0\u89C6\u9891\u6570\u636E" });
    return _jsx("div", { className: "v1-table-wrap", children: _jsxs("table", { className: "v1-table v1-video-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "\u8D26\u53F7" }), _jsx("th", { children: "\u89C6\u9891\u6807\u9898" }), _jsx("th", { children: "\u5173\u8054\u4EFB\u52A1" }), sortHeader("实际播放", "actualPlayCount"), sortHeader("播放差值", "playDelta"), _jsx("th", { children: "\u6628\u65E5\u5B9E\u9645\u64AD\u653E" }), sortHeader("今日新增播放量", "dailyPlayGrowth"), sortHeader("发布时间", "publishedAt")] }) }), _jsx("tbody", { children: sortedRows.map((row) => _jsxs("tr", { children: [_jsx("td", { children: row.accountName }), _jsx("td", { children: row.title }), _jsx("td", { title: row.taskName ?? undefined, children: row.taskName ?? "--" }), _jsx("td", { children: formatNumber(row.actualPlayCount) }), _jsx("td", { className: row.playDelta !== null && row.playDelta < 0 ? "v1-cell-negative" : undefined, children: formatSignedNumber(row.playDelta) }), _jsx("td", { children: formatNumber(row.yesterdayActualPlayCount) }), _jsx("td", { className: row.dailyPlayGrowth !== null && row.dailyPlayGrowth < 0 ? "v1-cell-negative" : undefined, children: formatSignedNumber(row.dailyPlayGrowth) }), _jsx("td", { children: formatDateTime(row.publishedAt) })] }, row.videoId)) })] }) });
}
